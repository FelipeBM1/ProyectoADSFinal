...
public class PensumController implements Initializable {

    String txt_Pensumcontroller;
    PensumController Pensumcontroller;
    
    //Elementos de la interfaz, se asignan automaticamente desde el archivo FXML con la opcion 'Make Controller"
    @FXML
    private Text pensumtext;
    @FXML
    ...
    private void consultarAction(ActionEvent event) {
        try{
            ...
            AnchorPane root = (AnchorPane)loader.load(getClass().getResource("pesumMateria.fxml").openStream());
            //Crea una instancia del controlador de la ventana que se quiere abrir
            PesumMateriaController PensumMateriaControllerInstancia = (PesumMateriaController)loader.getController();
            //solo trabaja con la instancia!!

            PensumMateriaControllerInstancia.recibeparametros(Pensumcontroller,matEscogido);
